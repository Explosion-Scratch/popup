...
function alert(o = "", e = () => {}) {
	...
	(t.id = "popup-bg"), document.documentElement.appendChild(t);
	try {
		...
		new Promise((n, u) => {
			document.getElementById("popup-close").onclick = () => {
				try {
					...
					p.classList.add("popup-closed"), t.remove(), u(o);
				}
			};
...
(style.innerHTML = styles), document.body.appendChild(style);
